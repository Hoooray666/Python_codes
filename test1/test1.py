...
def piggy_points(score):
    ...
    min_digits_of_squared_score=9
    if score==0:
        min_digits_of_squared_score=0
    while squared_score>0:
        digits_of_squared_score=squared_score%10
        if digits_of_squared_score<min_digits_of_squared_score:
            min_digits_of_squared_score=digits_of_squared_score
        squared_score//=10
    return 3+min_digits_of_squared_score
    # END PROBLEM 2
    ...
    def leftmost_digit(score):
        if score<10:
            ...
            while score>=10:
                score//=10
            return score
    def sec_leftmost_digit(score):
        while score>=100:
            score//=10
        return score%10
    if leftmost_digit(player_score)<leftmost_digit(opponent_score) and sec_leftmost_digit(player_score)<sec_leftmost_digit(opponent_score):
        return True
    else: return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==0:
            score0+=take_turn(strategy0(score0, score1), score1, dice=six_sided, goal=GOAL_SCORE)
            say(score0, score1)
            ...
            score1+=take_turn(strategy1(score1, score0), score0, dice=six_sided, goal=GOAL_SCORE)
            say(score0, score1)
