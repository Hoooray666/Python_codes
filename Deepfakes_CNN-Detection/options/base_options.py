...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--num_threads', default=4, type=int, help='# threads for loading my_data')
        ...
        parser.add_argument('--no_flip', action='store_true', help='if specified, do not flip the images for my_data augmentation')
